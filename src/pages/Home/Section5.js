...
import Brand7 from "../../assets/brands/brand-11.png";
import Brand8 from "../../assets/brands/brand-12.png";
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              <h4>MOBİL UYGULAMAYI İNDİRİN VE</h4>
              <h2>%20'YE VARAN İNDİRİM KAZANIN</h2>
              <p>
                Hemen Şahane Burger uygulamasını indirin, en popüler menülerimizi keşfedin ve 
                sadece uygulama kullanıcılarına özel kaçırılmayacak indirimlerden faydalanın.
                 Lezzeti yakalamak hiç bu kadar kolay olmamıştı.
              </p>
              <Link to="/">
                <img
                  src={StoreIOS}
